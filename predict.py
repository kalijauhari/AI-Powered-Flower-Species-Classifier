...
training_loader, testing_loader, validation_loader = kali.load_data()


kali.load_checkpoint(path)
...
probabilities = kali.predict(path_image, model, number_of_outputs, power)
